    ...
    return (
        <>
            ...
            <ol className="list-decimal list-outside pl-6 space-y-2 mb-16">
                ...
                <li>
                    Join the discord server at <a href="https://discord.gg/A6dTKTXNDD" target="_blank" rel="noopener noreferrer" className="text-theme-bright hover:underline">https://discord.gg/A6dTKTXNDD</a> and contact admins by creating a ticket in #open-ticket
                </li>
                <li>
